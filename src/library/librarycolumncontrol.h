...
//
// WTrackTableViewHeader persists draggable column order and sorting in the
// per-model header_state_pb. This class applies visibility and weighted widths
// after restoration, overriding the protobuf's layout dimensions.
//
