...
class WaveformWidgetFactory : public QObject, public Singleton<WaveformWidgetFactory> {
  ...
  private slots:
    ...
    void slotSetOverallVisualGain(double value);
    void slotSetDefaultZoomFromControl(double value);
    void slotResetDisplayDefaults(double value);
  ...
  private:
    ...
    QScopedPointer<ControlObject> m_pCODisplayVisualGain;
    QScopedPointer<ControlObject> m_pCODisplayZoom;
    QScopedPointer<ControlPushButton> m_pCOResetDisplayDefaults;
